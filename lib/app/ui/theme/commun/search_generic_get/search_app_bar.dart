...
import 'package:get_lab/app/ui/theme/commun/search_generic_get/search_paint.dart';
...
class _SearchAppBarState extends State<SearchAppBar>
  ...
  void animationStatusListener(AnimationStatus animationStatus) {
    if (animationStatus == AnimationStatus.completed) {
      ...
      widget.controller.setModSearch(true);
  ...
  void cancelSearch() {
    ...
    widget.controller.setModSearch(false);
    //widget.searcher.onClearSearchQuery();
    widget.controller.procure = '';
    _elevation = widget.elevation;
    _controller.reverse();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final bool isInSearchMode = widget.controller.isModSearch.value;
      return WillPopScope(
